/**
 * @file ESLint configuration for @seqlok/streambuf (bulk SWSR stream transport).
 * @license MIT
 */
...
/**
 * Directory of the @seqlok/streambuf package.
 * @type {string}
 */
...
/**
 * Flat ESLint configuration for @seqlok/streambuf.
 *
 * @type {import("typescript-eslint").ConfigArray}
 */
export default createPackageEslintConfig({
  name: "seqlok/streambuf",
